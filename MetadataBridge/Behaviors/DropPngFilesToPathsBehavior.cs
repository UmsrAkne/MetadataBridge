...
using MetadataBridge.ViewModels;
using Microsoft.Xaml.Behaviors;

namespace MetadataBridge.Behaviors
{
    public class DropPngFilesToPathsBehavior : Behavior<Window>
    {
        ...
        private void OnDrop(object sender, DragEventArgs e)
        {
            try
            {
                ...
                foreach (var path in pngs)
                {
                    ...
                    viewModel.ImageViewModels.Add(vm);
                }

                Console.WriteLine(fileList);
                e.Handled = true;
                Console.WriteLine($"Dropped {pngs.Count} files");
            }
            catch
            {
